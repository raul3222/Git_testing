...
//    }()
    ...
    let names = ["John", "Jim", "Tim", "Karl", "Ann",
                 "Peter", "Nik", "Lucy", "Mia", "Jane"]
    
    let lastNames = ["Murphy", "Jankin", "Williams", "Black", "Robertson",
                     "Butler", "Isaacson", "Smith", "Pennyworth", "Nolan"]
    
    let emails = ["qwe@mail.ru", "qqq@mail.ru", "www@mail.ru", "eee@mail.ru", "aaa@mail.ru",
                  "sss@mail.ru", "ddd@mail.ru", "zzz@mail.ru", "xxx@mail.ru", "ccc@mail.ru"]
    
    let phoneNumbers = ["123456789", "550220300", "660440100", "770999400", "440550660",
